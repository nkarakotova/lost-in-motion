...
Для ознакомления с эндпоинтами можно посмотреть на swagger. При запуске на своей машине он будет доступен по адресу ```http://localhost...```, в общем случае на 8080 по пути ```/api/v1/```.
