...
func (m *MockTransactionManager) Rollback(ctx context.Context, txRes *sqlx.CtxGetter, databasex *sqlx0.DB) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Rollback", ctx, txRes, databasex)
}

// Rollback indicates an expected call of Rollback.
func (mr *MockTransactionManagerMockRecorder) Rollback(ctx, txRes, databasex interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Rollback", reflect.TypeOf((*MockTransactionManager)(nil).Rollback), ctx, txRes, databasex)
}
